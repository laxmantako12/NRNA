...
import tennisImage from '../assets/images/tennis-bg.png';
        ...
        <div className='sports shadow  border-gray-800  overflow-hidden rounded-md bg-white mb-7'>
            <div className='sports_item'>
                <div className='sports_Header p-5 font-normal text-2xl bg-orange-600 text-white flex justify-between'>
                    ...
                    <h3 className='font-bold'><FontAwesomeIcon className='mr-2' icon={faTableTennisPaddleBall} />
                    Tennis <span>(36)</span></h3>
                    <div className='single-sports-img  tennis-bg'>
                        <img src={tennisImage} />
